...
export interface UseTagGroupActiveIndexChange<Item> extends UseTagGroupStateChange<Item> {
    activeIndex: number;
}
export interface UseTagGroupItemsChange<Item> extends UseTagGroupStateChange<Item> {
    items: Item[];
}
...
export type GetTagGroupProps = <Extra extends Record<string, unknown> = {}>(options?: GetTagGroupPropsOptions & Extra) => GetTagGroupPropsReturnValue & Extra;
export type GetTagProps = <Extra extends Record<string, unknown> = {}>(options: GetTagPropsOptions & Extra) => GetTagPropsReturnValue & Extra;
export type GetTagRemoveProps = <Extra extends Record<string, unknown> = {}>(options: GetTagRemovePropsOptions & Extra) => GetTagRemovePropsReturnValue & Extra;
export declare enum UseTagGroupStateChangeTypes {
...
export type UseTagGroupReducerAction<Item> = UseTagGroupTagClickReducerAction | UseTagGroupTagKeyDownArrowLeftAction | UseTagGroupTagKeyDownArrowRightAction | UseTagGroupTagKeyDownBackspaceAction | UseTagGroupTagKeyDownDeleteAction | UseTagGroupTagRemoveClickAction | UseTagGroupFunctionAddItem<Item>;
